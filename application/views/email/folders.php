            ...
            <div class = "col-md-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><?php echo $box_name_no; ?></h3><br><br>
                            ...
                            <table id="example2" class="table table-hover table-bordered datatable" style="height:330px;display:block;">
                                <thead>
                                    <tr>
                                        ...
                                        <?php
                                        if($box_name == "drafts" || $box_name == "sent")
                                        {
                                            ?>
                                            <th width="15%">To</th>
                                            <?php
            ...
            <div class = "row">
                <div class = "col-md-8">
                    <div style="--aspect-ratio: 5/1; margin-top: -13px;" id="view_container">
                        <iframe
                                id = "mail_view"
                                src="<?php echo base_url();?>email/getContent?mail_id=0&mail_box=INBOX.".<?php echo $box_name_no; ?>
                                width="1600"
                                height="900"
                                frameborder="0"
                        >
...
<script type="text/javascript">
    ...
    function mail_view(mail_id){
        $('#btnreply').attr('href', '<?php echo base_url();?>email/reply?mail_id='+mail_id+'&boxname=INBOX.<?php echo $box_name_no; ?>');
        $('#btnreply').removeAttr('disabled');
        $('#btnforward').attr('href', '<?php echo base_url();?>email/forward?mail_id='+mail_id+'&boxname=INBOX.<?php echo $box_name_no; ?>');
        ...
        $('#loader').fadeIn(1000);
        $("#mail_view").attr("src", "<?php echo base_url();?>email/getContent?mail_id="+mail_id+"&mail_box=INBOX.<?php echo $box_name_no; ?>");
        $.ajax({
            type: "get",
            url: "<?php echo base_url();?>email/getHeaderInfo",
            data: {
                mail_id: mail_id,
                mail_box: "INBOX.<?php echo $box_name_no; ?>"
            },
