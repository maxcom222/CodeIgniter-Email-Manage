...
class Login_model extends CI_Model
{
    ...
    {
        $this->db->select('BaseTbl.userId, BaseTbl.password, BaseTbl.name, BaseTbl.roleId, Roles.role, BaseTbl.usrimage' );
        $this->db->from('users as BaseTbl');
        $this->db->join('u_roles as Roles','Roles.roleId = BaseTbl.roleId');
    ...
    {
        $this->db->trans_start();
        $this->db->insert('u_last_login', $loginInfo);
    ...
    function lastLoginInfo($userId)
    {
        ...
        $this->db->limit(1);
        $query = $this->db->get('u_last_login as BaseTbl');
